...
pdf_prompt = "Identify the main companies or entities mentioned in this invoice."
...
# Moving on to the CSV analysis now.
...
csv_prompt = "Analyze this data and tell me about the contents."
